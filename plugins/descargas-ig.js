...
if (!args[0]) throw `${lenguajeGB['smsAvisoMG']()}insira algum link para fazer o download do vídeo ou imagem. por exemplo:\n_${usedPrefix + command} https://www.instagram.com/p/CCoI4DQBGVQ/?igshid=YmMyMTA2M2Y=_`
...
let txt1 = `✨ link: ${shortUrl1}\n\n${wm}`.trim()
await conn.sendFile(m.chat, videoig, 'error.mp4', txt1, m)     
} catch { 
console.log('Error en el intento 4, sin resultados')  
conn.sendMessage(m.chat, {text: `${lenguajeGB['smsAvisoFG']()} ocorreu algum erro no download, tente novamente.`, edit: key});
handler.limit = 0
}}}}}}
