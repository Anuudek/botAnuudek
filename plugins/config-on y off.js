...
await conn.reply(m.chat, `a função *${type}* foi ${isEnable ? lenguajeGB.smsEncender() : lenguajeGB.smsApagar()} com sucesso! configuração aplicada para o *${isAll ? lenguajeGB.smsMens4() : isUser ? '' : lenguajeGB.smsMens5()}*.`, fkontak, m)}	
