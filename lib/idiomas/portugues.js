...
const smsLista1 = () => { return `🌟 informação do Mint`}
...
const smsLista7 = () => { return `🐈 instalar Mint`}
...
//main.js
const smsWelcome = () => { return `olá, @user! você foi adicionado ao grupo @subject. eu sou a Mint, uma assistente virtual que pode te ajudar com várias coisas. prazer! :) 💚\n\n para saber mais sobre mim e o que eu posso fazer escreva e envie uma mensagem da seguinte forma: .menu\n\nvocê pode me chamar no privado também que, com a inteligência artifical que foi programada em mim, posso responder qualquer pergunta.\n\nqualquer coisa me acione!`}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 Mint '} 
const smsApagar = () => { return 'desativada ❌'} 
const smsEncender = () => { return 'ativada ✅'} 
...
const eGataCoins = () => { return '🐱 MintCoins' }
const eGataTickers = () => { return '🎫 Mint Tickers' } 
...
const smsModP2 = () => { return `Habilite o recurso para que todos possam usar o Mint`}
const smsModAd1 = () => { return `🛂 MODO ADMIN`}
const smsModAd2 = () => { return `Somente administradores poderão usar o Mint em grupos`}
...
const smsMens4 = () => { return `Mint`} 
const smsMens5 = () => { return `grupo`} 
...
//_antiviewonce.js
const smsAntiView = () => { return `_foto de vizualização única revelada_`} 
...
//_expired.js
const smsBottem1 = () => { return `saindo do grupo! caso queira usar novamente o Mint, use o comando _.bottemporal_.`} 
...
//propietario(a).js
const smsJoin = (user) => { return `*${packname}* - é um bot do WhatsApp que vai te ajudar a realizar diversas atividades de no privado ou em grupo. você também pode se divertir com suas múltiplas funções, aproveite o Mint! 😁\n\n💖 Mint foi convidado por: @${user}!`}
...
const smsContacto4 = () => { return 'contato oficial do Mint 🐈'}
